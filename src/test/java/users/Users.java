...
public class Users {
    ...
    public void incorrectPassword() throws IOException {
        props.load(file);
        UserLoginModel userLoginModel = new UserLoginModel("salman@grr.la", "123");
        RestAssured.baseURI = props.getProperty("BaseURL");
        Response res = given().contentType("application/json")
                .body(userLoginModel)
                .when().post("/user/login")
    ...
    public void getUserList() throws IOException {
        ...
        Assert.assertEquals(response.get("users[0].id").toString(), "55");
...
//                        "}")
    ...
    public void searchUser() throws IOException {
        ...
        Response res = given().contentType("application/json")
                ...
                .header("X-AUTH-SECRET-KEY", "ROADTOSDET")
                .when()
                .get("/user/search?id=" + props.getProperty("id"))
                .then().assertThat().statusCode(200).extract().response();
        JsonPath response = res.jsonPath();
    ...
    public void searchUserInvalidId() throws IOException {
        ...
        Response res = given().contentType("application/json")
                ...
                .header("X-AUTH-SECRET-KEY", "ROADTOSDET")
                .when()
                .get("/user/search?id=" + props.getProperty("947598347598347"))
//                .get("/user/search?id=" +  "947598347598347")
                .then().assertThat().statusCode(200).extract().response();
        JsonPath response = res.jsonPath();
    ...
    public void updateUser() throws IOException {
        ...
        Response res = given().contentType("application/json")
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put("/user/update/" + props.getProperty("id"))
                .then().assertThat().statusCode(200).extract().response();
        JsonPath response = res.jsonPath();
    ...
    public void userDelete() throws IOException {
        ...
        Response res = given().contentType("application/json")
                ...
                .header("X-AUTH-SECRET-KEY", "ROADTOSDET")
                .when()
                .delete("/user/delete/" + props.getProperty("id"))
                .then().assertThat().statusCode(200).extract().response();
        JsonPath response = res.jsonPath();
